...
if(isset($_POST["jam_id"]) && isset($_POST["rating"]) && isset($_POST["partecipantId"])  )
{
	...
	if($result && ((mysqli_num_rows($result)) != 0)){
		...
		$query1 ="UPDATE user_rating SET performance = '".$rating."'  where jam_session_id ='".$jamId."' and user_id = '".$id."' and rated_user ='".$partecipantId."'  ";
		...
		$query2 ="INSERT into user_rating(user_id , jam_session_id ,rated_user, performance) values('".$id."','".$jamId."', '".$partecipantId."' ,'".$rating."')  ";
