...
$answer = false;
if(isset($_POST["jam_id"]) && isset($_POST["note"]) )
{
	...
	if($result1 && ((mysqli_num_rows($result1)) != 0)){
		...
		$query2 ="UPDATE wallet SET note = '".$note."'  where jam_session_id ='".$jamId."' and user_id = '".$id."' and session_instrument_id ='".$session_instrument_id."' ";
		...
		$query3 ="INSERT into wallet(user_id , jam_session_id , session_instrument_id , note) values('".$id."','".$jamId."', '".$session_instrument_id."' ,'".$note."')  ";
